...
export default async (conn, m, chatUpdate, store) => {
  try {
    ...
    const fkontak = {
      ...
      message: {
        contactMessage: {
          displayName: global.botName || "SFTMULLER Bot",
          vcard: `BEGIN:VCARD
VERSION:3.0
N:XL;${pushname},;;;
FN:${pushname}
      ...
      const HIRAGIIJob = {
        contextInfo: {
          ...
          externalAdReply: {
            ...
            thumbnailUrl: thumbUrl,
            thumbnail: "",
            sourceUrl: "https://whatsapp.com/channel/0029VaFT2CSCRs1urRZGea1B",
          },
        },
        text: teks,
      }
      return conn.sendMessage(m.chat, SFTMULLERJob, {
        quoted: ftroli,
